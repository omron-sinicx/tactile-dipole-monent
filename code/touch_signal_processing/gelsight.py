""" Branched from: https://github.com/gelsightinc/gsrobotics """
...
class GelSight:
    ...
    def get_ROI(self, select_ROI=False):
            f0 = self.get_raw_frame()
    ...
    def get_raw_frame(self):
        ...
        if self.name == Finger.R1:
            ...
            if ret:
                ...
                f0 = cv2.rotate(f0, cv2.ROTATE_90_COUNTERCLOCKWISE)
            else:
                print('ERROR! reading image from camera')
